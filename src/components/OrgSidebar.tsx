...
const NameyourOrg = (props: UserDataProps) => {
              ...
              <ul className="mx-1 space-y-1 px-2  py-3">
                ...
                <span className="flex h-10 rounded-lg pb-3 pt-1.5 font-semibold   hover:bg-neutral-100 hover:text-purple-700">
                  <li className={`cursor-pointer ${!open && 'scale-0'} `}>
                    <Link href="/overview">
                      {' '}
                      <h2 className="pl-2 text-black">Overview</h2>
                    </Link>
                  </li>
                </span>
                ...
                <span className="flex h-10 rounded-lg pb-3 pt-1.5 font-semibold hover:bg-neutral-100 hover:text-purple-700">
                  <li className={`cursor-pointer ${!open && 'scale-0'} `}>
                    <h2 className="pl-2">Plan & Billing</h2>
                  </li>
                </span>

                <span className="flex h-10   rounded-lg pb-3 pt-1.5 font-semibold  hover:bg-neutral-100 hover:text-purple-700 ">
                  <li className={`cursor-pointer ${!open && 'scale-0'} `}>
                    <h2 className="pl-2"> Referrals</h2>
                  </li>
                </span>
                <span className="flex  h-10 rounded-lg pb-3 pt-1.5 font-semibold  hover:bg-neutral-100 hover:text-purple-700">
                  <li className={`cursor-pointer ${!open && 'scale-0'} `}>
                    <h2 onClick={goToTeamsPage} className="pl-2">
                      Team
                    </h2>
                  </li>
                </span>
                ...
                <span className="flex h-10  rounded-lg pb-3 pt-1.5 font-semibold  hover:bg-neutral-100 hover:text-purple-700">
                  <li className={`cursor-pointer ${!open && 'scale-0'}`}>
                    <h2 className="pl-2">Notifications</h2>
                  </li>
                </span>
                ...
                <span className="flex h-10 rounded-lg pb-3 pt-1.5 font-semibold  hover:bg-neutral-100 hover:text-purple-700">
                  ...
                  >
                    <h2 className="pl-2"> Media Library </h2>
                  </li>
                </span>

                <span className="flex h-10  rounded-lg pb-3 pt-1.5 font-semibold  hover:bg-neutral-100 hover:text-purple-700">
                  <li className={`cursor-pointer ${!open && 'scale-0'}`}>
                    <h2 className="pl-2"> Developer Apps</h2>
                  </li>
                </span>

                <span className="flex h-10  rounded-lg pb-3 pt-1.5 font-semibold  hover:bg-neutral-100 hover:text-purple-700">
                  <li className={`cursor-pointer ${!open && 'scale-0'}`}>
                    <h2 className="pl-2">Webhooks</h2>
                  </li>
                </span>
              </ul>
            </div>
